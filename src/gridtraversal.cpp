...
void GridTraversal::gridLineCore( const QPoint& start, const QPoint& end, GridLine& line )
{
...
void GridTraversal::gridLine( const QPoint& start, const QPoint& end, GridLine& line ) {
  int i,j;
  int half;
  QPoint v;
  line.clear();
